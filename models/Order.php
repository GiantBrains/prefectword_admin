...
class Order extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['ordernumber', 'topic', 'instructions'], 'required'],
            [['ordernumber', 'created_by', 'written_by', 'edited_by', 'service_id', 'type_id', 'urgency_id', 'spacing_id', 'pages_id', 'level_id', 'subject_id', 'style_id', 'sources_id', 'language_id', 'pagesummary', 'plagreport', 'initialdraft', 'qualitycheck', 'topwriter', 'cancelled'], 'integer'],
