                    ...
                    echo SideNav::widget([
                        ...
                        'items' => [
                            ...
                            ['label' => $this->params['available_count'] ? '<i class="fa fa-clock-o" aria-hidden="true"></i> <span class="pull-right badge">'.$this->params['available_count'].'</span> Available Orders':
                                '<i class="fa fa-clock-o" aria-hidden="true"></i> Available Orders', 'options'=>['class'=>'nav-link disabled'], 'active' => $this->context->route == 'order/available', 'url' => Yii::$app->request->baseUrl.'/order/available'],
