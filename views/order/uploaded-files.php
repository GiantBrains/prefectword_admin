    ...
    <ul class="nav nav-tabs" style="margin-bottom: 5px">
        ...
        <?php
         if ($model->paid == 1 && $model->available != 1){
            echo '<li role="presentation" class="active"><a href="'. \yii\helpers\Url::to(['order/uploaded-files', 'oid'=>$model->ordernumber]).'"><strong>Submit Order</strong></a></li>';
         }
    ...
    <div class="row">
        <div class="col-md-11">
            ...
            <div style="margin-top: 20px">
                ...
                'header'=>'<h4 style="text-align: center">Submit Order</h4>',
                'id'=>'supaModal',
                'toggleButton' => [
                'label'=>'<i class="fa fa-upload" aria-hidden="true"></i> Upload File', 'class'=>'btn btn-primary'
                ],
                ]);
