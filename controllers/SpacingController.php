...
use app\models\SpacingSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * SpacingController implements the CRUD actions for Spacing model.
 */
class SpacingController extends Controller
{
    ...
    /**
     * Displays a single Spacing model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Updates an existing Spacing model.
    ...
    /**
     * Deletes an existing Spacing model.
    ...
    /**
     * Finds the Spacing model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Spacing the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Spacing::findOne($id)) !== null) {
            return $model;
        }
